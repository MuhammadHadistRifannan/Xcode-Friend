...
<div class="pt-10 pb-6 bg-[#fafafa]">
    <!-- Container membentang penuh (w-full) dengan padding tipis di sisi kiri-kanan -->
    <div class="w-full max-w-[1400px] mx-auto px-6 lg:px-12 flex flex-col lg:flex-row gap-6 lg:gap-8">

        <!-- KONTEN KIRI: Kotak Keluar -->
        <div class="w-full lg:w-[70%] bg-[#f6f3f3] rounded-[24px] flex flex-col min-h-[650px] shadow-sm">
            ...
            <div class="px-8 pt-8 flex flex-col sm:flex-row justify-between items-end gap-4">
                <div class="flex space-x-8 border-b border-gray-300/60 w-full sm:w-[45%]">
                    <a href="{{ route('messages.index') }}" class="pb-3 text-sm font-medium text-gray-500 hover:text-gray-800 transition">Kotak Masuk</a>
                ...
                <table class="w-full text-left text-sm border-collapse">
                    ...
                    <tbody class="divide-y divide-transparent">
                        @forelse($messages as $msg)
                            <tr onclick="window.location='{{ route('messages.show', $msg->to_id) }}'" class="group cursor-pointer transition-colors text-gray-600 hover:bg-[#ebe5e5] rounded-lg">
                                ...
                                <td class="py-4 flex items-center gap-3">
                                    ...
                                    <span class="truncate max-w-[200px]">{{ $msg->receiver->fullname ?? 'Unknown' }}</span>
                                </td>
