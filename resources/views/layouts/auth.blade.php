...
<body class="min-h-screen bg-[#FAFAFA] text-neutral-900 font-sans antialiased flex relative">
    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 relative opacity-0 animate-fade-in-up stagger-3">
        ...
        <!-- Back to Home Button -->
        <div class="absolute top-6 right-6 lg:right-10 z-20">
            <a href="/" class="flex items-center text-[10px] sm:text-[11px] font-bold text-neutral-500 hover:text-[#990000] transition uppercase tracking-wider bg-white hover:bg-red-50 border border-neutral-200 hover:border-red-100 px-3 py-1.5 rounded-full shadow-sm">
