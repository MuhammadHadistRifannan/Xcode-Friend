<nav class="bg-[#0A0A0A] text-white border-b border-neutral-800 relative z-50">
    <div class="max-w-[96%] mx-auto px-4 sm:px-6 h-14 flex items-center justify-between relative">
        ...
        <!-- BAGIAN TENGAH: Menu Navigasi (Tepat di Tengah Layar) -->
        <div class="hidden md:flex absolute left-1/2 transform -translate-x-1/2 items-center space-x-8 text-[13px] font-medium text-neutral-400 mt-1">
            ...
            <div class="relative group py-4">
                <button class="flex items-center text-red-600 hover:text-red-500 transition font-semibold">
                    My Apps
                    <svg class="w-3 h-3 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
                </button>

                <!-- Menu Dropdown -->
                <div class="absolute left-1/2 transform -translate-x-1/2 mt-2 w-48 bg-[#1A1A1A] border border-neutral-800 rounded-md shadow-2xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 overflow-hidden">
                    <a href="#" class="flex items-center gap-3 px-4 py-2.5 bg-[#990000] text-white hover:bg-red-800 transition">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"></path></svg>
                        Dasbor
                    </a>
                    <a href="#" class="flex items-center gap-3 px-4 py-2.5 text-neutral-300 hover:bg-neutral-800 transition">
        ...
        <div class="flex-shrink-0 flex items-center justify-end space-x-4">
            ...
            @guest
                <a href="{{ route('login') }}" class="bg-red-700 w-8 h-8 rounded-full flex items-center justify-center hover:bg-red-600 transition shadow">
            ...
            @auth
                <div class="flex items-center space-x-3 text-neutral-400">
                    ...
                    <form method="POST" action="{{ route('logout') }}" class="ml-2 inline">
                        @csrf
                        <button type="submit" title="Logout" class="bg-[#990000] w-8 h-8 rounded-full flex items-center justify-center hover:bg-red-800 transition shadow cursor-pointer">
                            <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
                        </button>
                    </form>
                </div>
