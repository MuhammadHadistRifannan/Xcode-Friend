                ...
                @foreach($group->pendingMembers as $member)
                    <li class="flex justify-between items-center px-6 py-4 hover:bg-gray-50 transition-colors">
                        <div class="flex items-center gap-4">
                            <img src="{{ $member->avatar_url }}" alt="{{ $member->fullname ?? $member->username ?? $member->name }}" class="w-12 h-12 rounded-full object-cover bg-gray-100 border border-gray-200">
                            <div>
