        ...
        <div class="p-8">
            ...
            <form action="{{ route('groups.update', $group->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="flex items-center gap-3">
                    <input type="checkbox" name="is_private" id="is_private" class="w-5 h-5 text-blue-600 rounded border-gray-300 focus:ring-blue-500" {{ old('is_private', $group->type === 'private_group') ? 'checked' : '' }}>
