...
function photos_group_menu(&$tab_menu,$page) {
	$tab_menu[] = array(
		'name'=>'Photos',
		'type'=>'tab',
		'path'=>'photos/liststories/page_'.$page['id']
...
function photos_quick_share() {
	return array(
		'u' => array('access'=>'owner','flag' => t('Upload')),
		'page' => array('access'=>'connected','flag' => t('Upload')),
		'group' => array('access'=>'connected','flag' => t('Upload'))
		);
}