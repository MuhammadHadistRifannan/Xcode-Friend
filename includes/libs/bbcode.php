...
function decode_bb($msg){
        ...
        $replace_array = array(
            ...
            " <img src=\"\\1\" alt=\"User's Image\" onload=\"if(this.width>screen.width*0.7) {this.resized=true; this.width=screen.width*0.7; this.alt='Click here to open new window';}\" onmouseover=\"this.style.cursor='hand';\" onclick=\"window.open('\\1');\" /> ",
